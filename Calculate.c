...
{
	static double roundTemp; // DKOH : FEB-10-2022 : BUG#115
	roundTemp = Round_N (REG_TEMPERATURE.calc_val + REG_TEMP_ADJUST.calc_val + PDI_TEMP_ADJ,1); // DKOH : FEB-10-2022 : BUG#115
	VAR_Update(&REG_TEMP_USER, roundTemp, CALC_UNIT); // DKOH : FEB-10-2022 : BUG#115
